...
import postmanToOpenAPI from '../src';
...
const EXPECTED_BASIC = fs.readFileSync('./test/resources/output/Basic.yml', 'utf8');
const EXPECTED_BASIC_JSON = fs.readFileSync('./test/resources/output/Basic.json', 'utf8');
const EXPECTED_BASIC_NO_OPTS = fs.readFileSync('./test/resources/output/BasicNoOptions.yml', 'utf8');
const EXPECTED_INFO_OPTS = fs.readFileSync('./test/resources/output/InfoOpts.yml', 'utf8');
const EXPECTED_NO_VERSION = fs.readFileSync('./test/resources/output/NoVersion.yml', 'utf8');
const EXPECTED_CUSTOM_TAG = fs.readFileSync('./test/resources/output/CustomTag.yml', 'utf8');
const EXPECTED_FOLDERS = fs.readFileSync('./test/resources/output/Folders.yml', 'utf8');
const EXPECTED_FOLDERS_NO_CONCAT = fs.readFileSync('./test/resources/output/FoldersNoConcat.yml', 'utf8');
const EXPECTED_FOLDERS_SEPARATOR = fs.readFileSync('./test/resources/output/FoldersSeparator.yml', 'utf8');
const EXPECTED_GET_METHODS = fs.readFileSync('./test/resources/output/GetMethods.yml', 'utf8');
const EXPECTED_HEADERS = fs.readFileSync('./test/resources/output/Headers.yml', 'utf8');
const EXPECTED_AUTH_BEARER = fs.readFileSync('./test/resources/output/AuthBearer.yml', 'utf8');
const EXPECTED_AUTH_BASIC = fs.readFileSync('./test/resources/output/AuthBasic.yml', 'utf8');
const EXPECTED_BASIC_WITH_AUTH = fs.readFileSync('./test/resources/output/BasicWithAuth.yml', 'utf8');
const EXPECTED_AUTH_MULTIPLE = fs.readFileSync('./test/resources/output/AuthMultiple.yml', 'utf8');
const EXPECTED_PATH_PARAMS = fs.readFileSync('./test/resources/output/PathParams.yml', 'utf8');
const EXPECTED_MULTIPLE_SERVERS = fs.readFileSync('./test/resources/output/MultipleServers.yml', 'utf8');
const EXPECTED_SERVERS_OPTIONS = fs.readFileSync('./test/resources/output/ServersOpts.yml', 'utf8');
const EXPECTED_NO_SERVERS = fs.readFileSync('./test/resources/output/NoServers.yml', 'utf8');
const EXPECTED_LICENSE_CONTACT = fs.readFileSync('./test/resources/output/LicenseContact.yml', 'utf8');
const EXPECTED_LICENSE_CONTACT_OPT = fs.readFileSync('./test/resources/output/LicenseContactOpts.yml', 'utf8');
const EXPECTED_LICENSE_CONTACT_PARTIAL = fs.readFileSync('./test/resources/output/LicenseContactPartial.yml', 'utf8');
const EXPECTED_LICENSE_CONTACT_PARTIAL_2 = fs.readFileSync(
  './test/resources/output/LicenseContactPartial2.yml',
  'utf8',
);
const EXPECTED_DEPTH_PATH_PARAMS = fs.readFileSync('./test/resources/output/DepthPathParams.yml', 'utf8');
const EXPECTED_PARSE_STATUS_CODE = fs.readFileSync('./test/resources/output/ParseStatus.yml', 'utf8');
const EXPECTED_NO_PATH = fs.readFileSync('./test/resources/output/NoPath.yml', 'utf8');
const EXPECTED_DELETE = fs.readFileSync('./test/resources/output/DeleteOperation.yml', 'utf8');
const EXPECTED_URL_WITH_PORT = fs.readFileSync('./test/resources/output/UrlWithPort.yml', 'utf8');
const EXPECTED_EXTERNAL_DOCS = fs.readFileSync('./test/resources/output/ExternalDocs.yml', 'utf8');
const EXPECTED_EXTERNAL_DOCS_OPTS = fs.readFileSync('./test/resources/output/ExternalDocsOpts.yml', 'utf8');
const EXPECTED_EXTERNAL_DOCS_OPTS_PARTIAL = fs.readFileSync(
  './test/resources/output/ExternalDocsOptsPartial.yml',
  'utf8',
);
const EXPECTED_EMPTY_URL = fs.readFileSync('./test/resources/output/EmptyUrl.yml', 'utf8');
const EXPECTED_X_LOGO = fs.readFileSync('./test/resources/output/XLogo.yml', 'utf8');
const EXPECTED_X_LOGO_VAR = fs.readFileSync('./test/resources/output/XLogoVar.yml', 'utf8');
const EXPECTED_AUTH_OPTIONS = fs.readFileSync('./test/resources/output/AuthOptions.yml', 'utf8');
const EXPECTED_RESPONSES = fs.readFileSync('./test/resources/output/Responses.yml', 'utf8');
const EXPECTED_EMPTY_RESPONSES = fs.readFileSync('./test/resources/output/ResponsesEmpty.yml', 'utf8');
const EXPECTED_RESPONSES_MULTI_LANG = fs.readFileSync('./test/resources/output/ResponsesMultiLang.yml', 'utf8');
const EXPECTED_AUTH_REQUEST = fs.readFileSync('./test/resources/output/AuthRequest.yml', 'utf8');
const EXPECTED_RESPONSES_NO_HEADERS = fs.readFileSync('./test/resources/output/ResponsesNoHeaders.yml', 'utf8');
const EXPECTED_RESPONSES_WITHOUT_STATUS_CODE = fs.readFileSync(
  './test/resources/output/ResponsesWithoutHTTPStatusCode.yml',
  'utf8',
);
const EXPECTED_FORM_DATA = fs.readFileSync('./test/resources/output/FormData.yml', 'utf8');
const EXPECTED_FORM_URLENCODED = fs.readFileSync('./test/resources/output/FormUrlencoded.yml', 'utf8');
const EXPECTED_VARIABLES = fs.readFileSync('./test/resources/output/Variables.yml', 'utf8');
const EXPECTED_VARIABLES_ADDITIONAL = fs.readFileSync('./test/resources/output/VariablesAdditional.yml', 'utf8');
const EXPECTED_BASEPATH_VAR = fs.readFileSync('./test/resources/output/BasepathVar.yml', 'utf8');
const EXPECTED_RAW_BODY = fs.readFileSync('./test/resources/output/RawBody.yml', 'utf8');
const EXPECTED_NULL_HEADER = fs.readFileSync('./test/resources/output/NullHeader.yml', 'utf8');
const EXPECTED_COLLECTION_WRAPPER = fs.readFileSync('./test/resources/output/CollectionWrapper.yml', 'utf8');
const EXPECTED_COLLECTION_JSON_COMMENTS = fs.readFileSync('./test/resources/output/JsonComments.yml', 'utf8');
const EXPECTED_DISABLED_PARAMS_DEFAULT = fs.readFileSync('./test/resources/output/DisabledParamsDefault.yml', 'utf8');
const EXPECTED_DISABLED_PARAMS_ALL = fs.readFileSync('./test/resources/output/DisabledParamsAll.yml', 'utf8');
const EXPECTED_DISABLED_PARAMS_QUERY = fs.readFileSync('./test/resources/output/DisabledParamsQuery.yml', 'utf8');
const EXPECTED_DISABLED_PARAMS_HEADER = fs.readFileSync('./test/resources/output/DisabledParamsHeader.yml', 'utf8');
const EXPECTED_OPERATIONS_IDS = fs.readFileSync('./test/resources/output/OperationIds.yml', 'utf8');
const EXPECTED_OPERATIONS_IDS_AUTO = fs.readFileSync('./test/resources/output/OperationIdsAuto.yml', 'utf8');
const EXPECTED_OPERATIONS_IDS_BRACKETS = fs.readFileSync('./test/resources/output/OperationIdsBrackets.yml', 'utf8');
...
describe('Library specs', function () {
  ...
  describe.each(['v2', 'v21'])('Postman Collection %s', function (version) {
    ...
    it('should work with a basic transform', async function () {
      ...
      expect(fs.existsSync(OUTPUT_PATH)).to.be.true;
    });
  ...
  it('should work with string as input (instead of a file path)', async function () {
    const collectionString = await fsPromises.readFile(COLLECTION_NO_OPTIONS, 'utf8');
